...
ISSUE_DATE = {
    ...
    # 25附息国债18(7Y)：起息日按剩余期限 5.98Y(2026-09-22) 反推 ≈2025-09-20，待用户核对。
    # 含税判定不受具体日期影响：序号在 250016(2025-08-25) 之后，必晚于 2025-08-08 临界。
    "250018.IB":  date(2025, 9, 20),   # 25附息国债18 含税（起息日反推，待核对）
