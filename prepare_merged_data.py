...
# 映射到新口径
# ★ 2026-09-03 修正为官方口径（与 daily_update.py 保持一致，勿只改一处）
OLD_TO_NEW_MAP = {
    "大型商业银行/政策性银行": "大型银行",
    "股份制商业银行": "大型银行",          # ★官方：大型银行含股份制银行
    "城市商业银行": "中小型银行",
    "农村金融机构": "中小型银行",
    "外资银行": "中小型银行",
    "证券公司": "证券公司",
    ...
    "货币市场基金": "货币市场基金",
    "其他": "其他",
    "其他产品类": "其他",                  # ★官方：其他含"其他投资产品"
    "境外机构": "其他",                    # ★新8类无独立桶；丢弃会破坏零和性
}
...
def main():
    ...
    output = {
        "meta": {
            ...
            "note": "合并数据，仅用于因子分析。旧文件(2021-2025)机构13→8映射按官方口径：大型商业银行/政策性银行+股份制商业银行→大型银行；城市商业银行+农村金融机构+外资银行→中小型银行；其他产品类+境外机构→其他（不丢弃任何类别，保证净买入零和）",
        },
